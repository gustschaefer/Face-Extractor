...
- [Como executar o programa](#como-executar-o-programa)
	- [Detecção das faces e recorte](#detecção-das-faces-e-recorte-(1°-filtragem))
	- [Classificação das imagens recortadas](#classificação-das-imagens-recortadas-(2°-filtragem))
